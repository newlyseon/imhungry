...
const FASTING_TYPES: {
  ...
  { label: '14:10', fastHours: 14, eatHours: 10, tag: '표준', tagColor: '#006ACD', desc: '하루 10시간 안에 식사를 마치고 꾸준한 리듬을 만들어가요.' },
  { label: '16:8',  fastHours: 16, eatHours: 8,  tag: '일반', tagColor: '#006ACD', desc: '비움과 채움이 조화를 이루는 일상의 균형을 경험해보세요.' },
...
export function FastingTypeScreen() {
  return (
    <Box sx={{ minHeight: '100dvh', bgcolor: 'background.default', px: '24px', pt: '44px', pb: '100px' }}>
      ...
      <Typography sx={{ fontSize: '16px', color: SUB_COLOR, mb: '32px' }}>
        각 유형의 특징을 확인해보세요
      </Typography>
          ...
          >
            <Box sx={{ mx: '24px' }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: '10px', mb: '8px' }}>
                ...
                >
                  <Typography sx={{ fontSize: '12px', fontWeight: 700, color: type.tagColor }}>
                    {type.tag}
                  </Typography>
                </Box>
              </Box>
              <Box sx={{ display: 'flex', gap: '16px', mb: '10px' }}>
                <Box>
                  <Typography sx={{ fontSize: '12px', color: SUB_COLOR, mb: '2px' }}>단식</Typography>
                  <Typography sx={{ fontSize: '14px', fontWeight: 700, color: '#000' }}>{type.fastHours}시간</Typography>
                </Box>
                <Box sx={{ width: '1px', bgcolor: '#E5E9EF' }} />
                <Box>
                  <Typography sx={{ fontSize: '12px', color: SUB_COLOR, mb: '2px' }}>식사</Typography>
